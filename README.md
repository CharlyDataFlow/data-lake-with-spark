...
Sparkify, a music streaming startup, wants to transition from a data warehouse to a data lake due to the company's increased user base and song database. Their data is stored in S3, where it can be found in a directory with JSON metadata for the songs in their app and logs of user activity on the app.
